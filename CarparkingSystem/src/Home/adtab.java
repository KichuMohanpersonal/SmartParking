...
public class adtab extends JFrame {
...
private final ButtonGroup buttonGroup_2 = new ButtonGroup();
	...
	/*	
		...
		*/
		...
		JLabel lblCostumerNo = new JLabel("Vehicle Registration Number: ");
		...
		JLabel lblEnterInfo = new JLabel("Enter Details to book slot");
		...
		//code for display all the info
		
		JPanel panel_16 = new JPanel();
		tabbedPane.addTab("Show Information", null, panel_16, null);
		panel_16.setLayout(new BorderLayout(0, 0));
		
		JPanel panel_19 = new JPanel();
		panel_19.setBorder(new EmptyBorder(5, 5, 5, 5));
		panel_19.setBackground(SystemColor.activeCaption);
		panel_16.add(panel_19, BorderLayout.CENTER);
		panel_19.setLayout(null);
		
		textField_23 = new JTextField("");
		textField_23.setBackground(SystemColor.activeCaptionBorder);
		textField_23.setBounds(308, 68, 231, 20);
		textField_23.setColumns(10);
		panel_19.add(textField_23);
		
		textField_15 = new JTextField("");
		textField_15.setBackground(SystemColor.activeCaptionBorder);
		textField_15.setBounds(130, 220, 120, 30);
		textField_15.setColumns(10);
		panel_19.add(textField_15);
		
		textField_16 = new JTextField("");
		textField_16.setBackground(SystemColor.activeCaptionBorder);
		textField_16.setBounds(260, 220, 120, 30);
		textField_16.setColumns(10);
		panel_19.add(textField_16);
		
		
		textField_17 = new JTextField("");
		textField_17.setBackground(SystemColor.activeCaptionBorder);
		textField_17.setBounds(390, 220, 120, 30);
		textField_17.setColumns(10);
		panel_19.add(textField_17);
		...
		button_15.setBounds(330, 439, 142, 39);
		button_15.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ad_select obj=new ad_select();
				obj.selection(textField_23.getText());
				
			}
		});
		panel_19.add(button_15);
		
		JButton button_18 = new JButton("Cancel");
		button_18.setBounds(159, 439, 89, 39);
		button_18.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dispose();
			}
		});
		panel_19.add(button_18);
		
		
		JLabel lblCarrId = new JLabel("Slot Number:");
		lblCarrId.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblCarrId.setBounds(96, 71, 119, 14);
		panel_19.add(lblCarrId);
		
		JLabel carreg = new JLabel("VehicleReg No");
		carreg.setFont(new Font("Tahoma", Font.BOLD, 15));
		carreg.setBounds(140, 180, 119, 14);
		panel_19.add(carreg);
		
		
		JLabel model = new JLabel("Model");
		model.setFont(new Font("Tahoma", Font.BOLD, 15));
		model.setBounds(270, 180, 119, 14);
		panel_19.add(model);
		
		
		JLabel contact = new JLabel(" Contact");
		contact.setFont(new Font("Tahoma", Font.BOLD, 15));
		contact.setBounds(400, 180, 119, 14);
		panel_19.add(contact);
		//Code ends here
	/*	
		...
		*/
		...
		tabbedPane.addTab("Block Slot", null, panel_6, null);
		...
		*/
		JButton button_5 = new JButton("Block slot");
		button_5.setBounds(330, 439, 142, 39);
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ad_block obj=new ad_block();
				obj.selection(textField_13.getText());
			}
		});
		panel_9.add(button_5);
		
		JLabel lblEnterInfo_1 = new JLabel("Enter Slot to Block the Slot");
		lblEnterInfo_1.setBounds(277, 25, 285, 28);
		lblEnterInfo_1.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 20));
		panel_9.add(lblEnterInfo_1);
		...
		*/
		...
		button_8.setBounds(159, 439, 89, 39);
	...
	//unblock code
		...
		JPanel panel_1 = new JPanel();
		tabbedPane.addTab("Delete/Unblock", null, panel_1, null);
		panel_1.setLayout(null);
		...
		JButton button_1 = new JButton("Delete/Unblock");
		button_1.setBounds(407, 327, 150, 43);
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ad_delete obj=new ad_delete();
				obj.delete(textField_6.getText());
			}
		});
		panel_5.setLayout(null);
		...
		JLabel lblEnterInfo2 = new JLabel("Enter Slot to to free the Slot");
		lblEnterInfo2.setBounds(277, 25, 285, 28);
		lblEnterInfo2.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 20));
		panel_5.add(lblEnterInfo2);
		
		
		
		JLabel lblEnterCarNo = new JLabel("Enter Slot :");
		lblEnterCarNo.setBounds(162, 152, 168, 23);
		lblEnterCarNo.setFont(new Font("Tahoma", Font.BOLD, 14));
		panel_5.add(lblEnterCarNo);
		/*
		...
		*/
		JButton button_4 = new JButton("Cancel");
		button_4.setBounds(280, 327, 150, 43);
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dispose();
			}
